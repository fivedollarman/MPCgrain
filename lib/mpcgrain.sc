  ...
  *new { arg context, doneCallback;
  ...
  alloc {
    ...
    diskread = {
      ...
      var bufpos = context.server.sampleRate*(60/bpm)*step*(pos-1);
      sbuff.readChannel("/home/we" ++ path, fileStartFrame: 0, numFrames: -1, bufStartFrame: bufpos, leaveOpen: false, channels: 0);
    };
