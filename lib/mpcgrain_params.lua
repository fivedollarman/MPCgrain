...
local mspecs = {
  ...
  ["noisecut"] = controlspec.new(0.5, 127, "lin", 0, 8, ""),
  ...
  ["poslfo"] = controlspec.new(-0.5, 0.5, "lin", 0.01, 0, ""),
  ["filtlfo"] = controlspec.new(-0.5, 0.5, "lin", 0.01, 0, ""),
  ["panlfo"] = controlspec.new(-0.5, 0.5, "lin", 0.01, 0, ""),
  ["delllfo"] = controlspec.new(-0.5, 0.5, "lin", 0.01, 0, ""),
  ["delrlfo"] = controlspec.new(-0.5, 0.5, "lin", 0.01, 0, ""),
  ["pitchnoise"] = controlspec.new(-0.5, 0.5, "lin", 0.01, 0, ""),
  ["durnoise"] = controlspec.new(-0.5, 0.5, "lin", 0.01, 0, ""),
