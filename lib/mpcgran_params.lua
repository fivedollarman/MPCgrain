...
local mspecs = {
  ...
  ["noisecut"] = controlspec.new(8, 128, "lin", 1, 8, ""),
  ["pitchlfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["durlfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["trigflfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["poslfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["filtlfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["panlfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["delllfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["delrlfo"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["pitchnoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["durnoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["trigfnoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["posnoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["filtnoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["pannoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["dellnoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
  ["delrnoise"] = controlspec.new(0, 1, "lin", 0, 1, ""),
